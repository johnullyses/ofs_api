...
process_lalamove_webhook($post_data);

function process_lalamove_webhook($post_data)
{
    ofs_request('lalamove_delivery_status_changed', 'lalamove', $post_data);
}
...
function ofs_request($action, $source, $contents)
{
    try {
        ...
        // Access Token
        $api_id = 'lalamove_webhook';
        $public_key     = 'pk_test_6d4746a7657c3bfb6252896ad048756a';
        $private_key    = 'sk_test_xYUwFpABcRRO6kx5ejBiwwW6tsqp0hZZmUmf2ozy1GL/FIBnJWH49tcD0QFU3psL';
        ...
        // OFS API URL
        $url = 'http://192.168.10.32/api/lalamove-webhook/status-update';
